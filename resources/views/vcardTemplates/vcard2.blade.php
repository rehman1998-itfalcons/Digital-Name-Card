...
<div class="container">
    ...
    <div class="vcard-two main-content w-100 mx-auto overflow-hidden content-blur collapse show allSection">
        ...
        <div class="vcard-two__profile-details py-3 px-3">
            ...
            <span class="profile-description d-flex pt-4"> {{$vcard->description}}</span>
        ...
        <div class="vcard-two__event py-3 px-3">
            ...
            @endif
                @if($vcard->alternative_email)
                    <div class="event-details d-flex">
                        <div class="event-image">
                            <img src="{{asset('assets/img/vcard2/alter-image.png')}}" alt="email" height="20" width="27"/>
                        </div>
            ...
            @endif
                @if($vcard->alternative_phone)
                    <div class="event-details d-flex">
                        <div class="event-image">
                            <img src="{{asset('assets/img/vcard2/old-typical-phonevcard2.png')}}" alt="phone" class=""/>
                        </div>
                        <span><a href="tel:+{{ $vcard->region_code }} {{ $vcard->alternative_phone }}"
                                 class="event-name text-center pt-3 mb-0 email-btn text-decoration-none">+{{ $vcard->region_code }} {{ $vcard->alternative_phone }}</a></span>
                    </div>
                @endif
            @if($vcard->location)
                <div class="event-details d-flex">
